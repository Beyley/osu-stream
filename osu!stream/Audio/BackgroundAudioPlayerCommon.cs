...
{
    /// <summary>
    /// Works for both Desktop and Android platforms.
    /// </summary>
    internal class BackgroundAudioPlayerCommon : BackgroundAudioPlayer
    {
        private GCHandle audioHandle;
        private static int audioStream;

        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundAudioPlayerCommon"/> class.
        /// </summary>
        public BackgroundAudioPlayerCommon()
        {
