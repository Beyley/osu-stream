        ...
        private void handleMotionEvent(int i, MotionEvent e)
        {
            ...
            switch (e.Action)
            {
                case MotionEventActions.Down:
                    ...
                    TriggerOnDown(point);
                    System.Diagnostics.Debug.WriteLine("DOWN " + e.GetPointerId(i));
                    break;
                ...
                case MotionEventActions.Up:
                    ...
                    TriggerOnUp(point);
                    System.Diagnostics.Debug.WriteLine("CANCEL " + e.GetPointerId(i));
                    break;
                case MotionEventActions.Move:
                    ...
                    TriggerOnMove(point);
                    System.Diagnostics.Debug.WriteLine("MOVE " + e.GetPointerId(i));
                    break;
            }
        }
